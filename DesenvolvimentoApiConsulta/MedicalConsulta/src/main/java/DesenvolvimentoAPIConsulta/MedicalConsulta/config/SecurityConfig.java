package DesenvolvimentoAPIConsulta.MedicalConsulta.config;
...
public class SecurityConfig {
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception { //paramentro na funcao para gerenciar usuario
        ...
        auth.inMemoryAuthentication()
                ...
                .and()
                .withUser("Pedro").password(passwordEncoder.encode("123")).roles("SECRETARIO")
                .and()
                .withUser("Arthur").password(passwordEncoder.encode("1234")).roles("PACIENTE");
    }
}
