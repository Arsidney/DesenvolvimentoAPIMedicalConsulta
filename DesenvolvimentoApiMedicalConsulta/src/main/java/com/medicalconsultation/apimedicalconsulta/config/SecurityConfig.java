package com.medicalconsultation.apimedicalconsulta.config;
...
public class SecurityConfig {
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.inMemoryAuthentication()
                .withUser("Arsidney").password(passwordEncoder.encode("12345")).roles("ADMIN")
                .and()
                .withUser("Martins").password(passwordEncoder.encode("1234")).roles("SECRETARIO")
                .and()
                .withUser("Sicrano").password(passwordEncoder.encode("123")).roles("PACIENTE");
    }
